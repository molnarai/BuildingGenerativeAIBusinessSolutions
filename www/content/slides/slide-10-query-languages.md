+++
title = "LLMs and Query Languages"
description = "How to translate natural questions into database queries."
weight = 90
outputs = ["Reveal"]
math = true
thumbnail = "/imgs/slides/nl-to-query.png"
...
+++
{{< slide background-image="/imgs/slides/nl-to-query.png" >}}
<div style="margin:0; padding: 50; background-color: rgba(0,0,0,0.5); min-hight:100%; min-width:100%" >

<h1 style="color:white; text-shadow: 2px 2px 4px rgba(0,0,0,0.7);" >LLMs and Query Languages</h1>

<p style="color:white; text-shadow: 2px 2px 4px rgba(0,0,0,0.7);" > MSA 8700 — Module 10
</p>
</div>
